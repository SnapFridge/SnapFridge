  ...
  <AFooter>
    <div>
      ...
      <LinksContainer>
        ...
        <li><Link href="/snap">Try SnapFridge</Link></li>
        <li><Link href="/about">About Us</Link></li>
      </LinksContainer>
    </div>
    <div className={RightFooterCSS}>
      <Link href="mailto:repulseshipp@gmail.com"><Icon icon="Mail"/></Link>
      <Link href="https://github.com/msqr1/SnapFridge"><Icon icon="Github"/></Link>
    </div>
  </AFooter>
  )
}
